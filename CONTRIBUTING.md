# Contributing to al-linkml-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
al-linkml-schema. These guidelines are not strict rules.
...
The al-linkml-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the al-linkml-schema technical leads
...
[issues]: https://github.com/r1tger/al-linkml-schema/issues/
[pulls]: https://github.com/r1tger/al-linkml-schema/pulls/
